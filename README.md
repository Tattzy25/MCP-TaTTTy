<div align="center">
 <h1><img src="images/tatttttz.png" width="160px"><br/>MCP-TaTTTy</h1>
</div>
...
This is an MCP ([Model Context Protocol](https://modelcontextprotocol.io/)) Server for AI-powered tattoo image generation and manipulation. Generate thousands of tattoo designs across different styles, shapes, colors, sizes, and placements using Stability AI's advanced image generation models.

This server connects directly to [Stability AI](https://stability.ai/)'s [hosted REST API](https://platform.stability.ai/docs/api-reference). You will need to sign up for an [API Key from stability.ai](https://platform.stability.ai/account/keys) to get started.

They provide 25 credits for free. Afterward, [pay-as-you-go pricing](https://platform.stability.ai/pricing) is very reasonable: $0.01/credit, where 3 credits gets you an image generation on their Core model.
...
| `IMAGE_STORAGE_DIRECTORY` | Directory where generated images will be saved                                                            | N                  | `/tmp/tadasant-mcp-tatttyai` OR `C:\\Windows\\Temp\\mcp-tatttyai` | `/Users/admin/Downloads/stability-ai-images` (Mac OS/Linux), `C:\\Users\\Admin\\Downloads\\stability-ai-images` (Windows)|
...
- `/Users/<username>/Library/Application Support/Claude/mcp-tatttyai/images`
...
<img src="https://github.com/tadasant/mcp-tatttyai/blob/main/images/claude-1.png" width="500" alt="Claude First Image">

<img src="https://github.com/tadasant/mcp-tatttyai/blob/main/images/claude-2.png" width="500" alt="Claude Second Image">
